...
fileprivate var viewControl = UIViewController()
...
class HHGuidePageHUD: UIView {
    ...
    init(imageNameArray:[String], isHiddenSkipButton: Bool, viewController: UIViewController) {
    ...
    init(videoURL: URL, isHiddenSkipButton: Bool) {
        ...
        movieStartButton.setTitle(text_enter_app, for: .normal)
        movieStartButton.titleLabel?.font = UIFont.pingfang(22, .light)
...
extension HHGuidePageHUD {
    ...
    func addSkipButton(isHiddenSkipButton: Bool) -> Void {
        ...
        skipButton.setTitle(text_skip, for: .normal)
        skipButton.backgroundColor = UIColor.gray
        skipButton.titleLabel?.font = UIFont.pingfang(20, .light)
    ...
    func addImages() -> Void {
        ...
        for i in 0..<imageArray.count {
            ...
            if i == imageArray.count - 1 {
                ...
                startButton.titleLabel?.font = UIFont.pingfang(22, .light)
                startButton.setTitle(text_enter_app, for: .normal)
                startButton.setTitleColor(UIColor.white, for: .normal)
                startButton.setBackgroundImage(UIImage.init(named: enter_app_image_name), for: .normal)
